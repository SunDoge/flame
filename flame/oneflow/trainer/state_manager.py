...
class StateManager:
    ...
    def register_lr_scheduler(
        ...
        self.register(name, lr_scheduler.state_dict,
                      lr_scheduler.load_state_dict)

    def register_grad_scaler(self, grad_scaler, name: str = "grad_scaler"):
        # self.register(name, grad_scaler.state_dict,
