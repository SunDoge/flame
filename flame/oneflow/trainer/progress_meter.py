...
from flame.oneflow.meters.average_meter import (AverageMeter,
...
class _SummaryWriter:
    ...
    def add_scalar(self, value, global_step=None):
        pass
...
class ProgressMeter:
    ...
    def enumerate(self, iterable, num_iters: Optional[int] = None):
        ...
        with tqdm(
            ...
            ascii=True,
            position=0,
            disable=self._no_tqdm or oneflow.env.get_rank() != 0  # 如果不是 rank0，就关掉 tqdm
    ...
    def write_summary(self, summary_writer: _SummaryWriter, trainer_name: Optional[str] = None):
